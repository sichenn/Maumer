...
namespace Maumer.Internal
{
    ...
    public class DebugViewerEditor : Editor
    {

        // DebugViewer viewer;
        // /// <summary>
        // /// Number of DebugViewer frames in the last game frame
        // /// </summary>
        // float prevNumFrames;
        // bool isPlaying;
        ...
        //     viewer.frameIndex = EditorGUILayout.IntSlider(viewer.frameIndex, 0, viewer.NumFrames - 1);

        //     // Display all frames when frame number is changed 
        //     if (viewer.NumFrames != prevNumFrames)
        //     {
        //         viewer.frameIndex = viewer.NumFrames - 1;
        //     }
        //     GUILayout.Space(6);
        ...
        //     prevNumFrames = viewer.NumFrames;
        // }
        ...
        // void EditorUpdate()
        // {
        //     if (VisualDebugSaveLoad.HasNewSaveWaiting)
        //     {
        //         viewer.Load();
        //     }
